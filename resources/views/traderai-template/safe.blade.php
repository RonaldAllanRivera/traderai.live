     ...
     <div class="col-lg-5">
      <div class="home-form" id="req-form-section">
       ...
       <div class="home-form-inner">        
        <div class="home-form-inner">
        Interested in exploring Trader Ai? Start with our educational materials and platform overview, no deposit required. If you would like a walkthrough or have questions about features, security, or regional availability, contact our team through the official channels on this site. We will use your details only to respond to your inquiry, we do not sell your data. Trading involves risk, results are not guaranteed, consider seeking independent financial advice before committing funds.         
        </div>
       </div>
      </div>
     </div>
