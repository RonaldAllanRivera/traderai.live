   ...
   <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
      ...
      <form action="{{ route('leads.store') }}" class="form-registration space-y-4 sm:space-y-6" method="POST" onsubmit="return validateForm();">
       ...
       <div class="space-y-3 sm:space-y-4 hidden" id="phone-section">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:gap-3">
         <input class="phone flex-1 w-full px-4 py-2 sm:py-3 rounded-lg border border-gray-300 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm" id="phoneNumber" name="phone_number" placeholder="Phone Number" type="tel" data-force-country="{{ $forceCountry ? '1' : '0' }}"/>
        </div>
        <!-- Country notice -->
    ...
    <div class="space-y-8 sm:space-y-12 mb-6 sm:mb-8">
     ...
     <div class="text-center">
      <a href="#" class="inline-block bg-primary text-white text-lg sm:text-xl font-bold px-8 sm:px-12 py-3 sm:py-4 !rounded-button hover:bg-primary/60 transition-colors scroll-link">CLICK TO START</a>
     </div>
    </div>
   </article>
   <!-- Sidebar -->
    ...
    <div class="bg-white rounded-lg shadow-sm border p-4 sm:p-6">
     ...
     <div class="space-y-4 sm:space-y-6">
      <div class="flex items-start space-x-3 sm:space-x-4">
       ...
       <div>
        <h4 class="font-bold text-gray-900 mb-1 line-clamp-2 text-sm sm:text-base">Fear not, the stock market still holds potential for recovery.</h4>
      ...
      <div class="flex items-start space-x-3 sm:space-x-4">
       ...
       <div>
        <h4 class="font-bold text-gray-900 mb-1 line-clamp-2 text-sm sm:text-base">The Secret Weapon for High-Profit, Low-Risk Investment Strategies has been released</h4>
